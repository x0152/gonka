...
var (
	...
	ErrTrainingDisabled                      = sdkerrors.Register(ModuleName, 1200, "training feature is disabled")
	ErrTrainshardProposalNotFound            = sdkerrors.Register(ModuleName, 1201, "training proposal not found")
	...
	ErrTrainshardNodeNotOwned                = sdkerrors.Register(ModuleName, 1211, "node is not owned by the host")
	ErrTrainshardProfileEmpty                = sdkerrors.Register(ModuleName, 1212, "gpu profile id must not be empty")
	ErrTrainshardNotActive                   = sdkerrors.Register(ModuleName, 1213, "trainshard is not active")
	ErrTrainshardNodeNotActive               = sdkerrors.Register(ModuleName, 1214, "node is not an active node of the trainshard")
	ErrTrainshardAutokickNotAllowed          = sdkerrors.Register(ModuleName, 1215, "signer may not autokick nodes of this trainshard")
