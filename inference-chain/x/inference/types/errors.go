...
var (
	...
	ErrTrainingDisabled                      = sdkerrors.Register(ModuleName, 1198, "training feature is disabled")
	ErrTrainshardProposalNotFound            = sdkerrors.Register(ModuleName, 1199, "training proposal not found")
	ErrTrainshardProposalNotOpen             = sdkerrors.Register(ModuleName, 1200, "training proposal is not open")
	ErrTrainshardProfileNotAllowed           = sdkerrors.Register(ModuleName, 1201, "gpu profile is not allowed for training")
	ErrTrainshardProposalLimits              = sdkerrors.Register(ModuleName, 1202, "training proposal violates static caps")
	ErrTrainshardCapacity                    = sdkerrors.Register(ModuleName, 1203, "insufficient free training capacity for request: every model keeps at least one node free, so a model can lend at most min(cap, capacity-1) of its nodes")
	ErrTrainshardNotFound                    = sdkerrors.Register(ModuleName, 1204, "trainshard not found")
	ErrTrainshardNotCreator                  = sdkerrors.Register(ModuleName, 1205, "only the shard creator may settle it")
	ErrTrainshardCooldown                    = sdkerrors.Register(ModuleName, 1206, "creator is within training cooldown window")
	ErrTrainshardActiveLimit                 = sdkerrors.Register(ModuleName, 1207, "active shard limit reached")
	ErrTrainshardNodeReserved                = sdkerrors.Register(ModuleName, 1208, "node is reserved by an active trainshard")
	ErrTrainshardNodeNotOwned                = sdkerrors.Register(ModuleName, 1209, "node is not owned by the host")
	ErrTrainshardProfileEmpty                = sdkerrors.Register(ModuleName, 1210, "gpu profile id must not be empty")
	ErrTrainshardNotActive                   = sdkerrors.Register(ModuleName, 1211, "trainshard is not active")
	ErrTrainshardNodeNotActive               = sdkerrors.Register(ModuleName, 1212, "node is not an active node of the trainshard")
	ErrTrainshardAutokickNotAllowed          = sdkerrors.Register(ModuleName, 1213, "signer may not autokick nodes of this trainshard")
	ErrTrainshardBaseImageInvalid            = sdkerrors.Register(ModuleName, 1214, "base image must be pinned as repository@sha256:<digest>")
	ErrTrainshardOptInRequest                = sdkerrors.Register(ModuleName, 1215, "invalid training opt-in request")
	ErrTrainshardAutokickRequestReused       = sdkerrors.Register(ModuleName, 1216, "autokick request id was already used for a different node")
)
