...
replace github.com/cosmos/cosmos-sdk => github.com/gonka-ai/cosmos-sdk v0.53.3-ps19-observability

replace github.com/gogo/protobuf => github.com/regen-network/protobuf v1.3.3-alpha.regen.1

replace cosmossdk.io/store => github.com/gonka-ai/cosmos-sdk/store v1.1.2-ps1
